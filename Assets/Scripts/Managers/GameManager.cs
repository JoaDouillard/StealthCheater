...
public class GameManager : MonoBehaviour
{
    ...
    public void OnPlayerDetected()
    {
        ...
        // Notifier le WeekManager (système de semaine/examens)
        if (WeekManager.Instance != null)
        {
            WeekManager.Instance.OnPlayerCaught();
        }
        else
        {
            Debug.LogWarning("[GameManager] WeekManager non trouvé, impossible de gérer Game Over du système de semaine");
        }

        // Charger la scène GameOver
        Time.timeScale = 1f; // Reprendre le temps avant changement de scène
