...
public class LevelConfiguration : ScriptableObject
{
    ...
    [Tooltip("Offset de rotation à appliquer à tous les objets spawnés (utile pour les niveaux avec orientations différentes)")]
    ...
    [Header("Multi-Raycast Detection")]
    [Tooltip("Pourcentage minimum de raycasts réussis pour détecter le player (20% = très permissif, 50% = stricte, 100% = ultra stricte)")]
    [Range(0f, 100f)]
